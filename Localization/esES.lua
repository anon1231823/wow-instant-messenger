...
local translations = {
    ...
    ["_Description"] = "WIM es un addon que aporta una sensación familiar a la comunicación a través del chat. En esta pantalla podrá personalizar WIM para adaptarlo a tus necesidades.",
